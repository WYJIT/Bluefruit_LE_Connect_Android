...
public class MessageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        messages.add(new Message(new Patient("Jordan", 62, "Female", 158, 7, 1),  "Hello, just wanna double check...", false));
        messages.add(new Message(new Patient("Issac", 55, "Male", 136, 6, 3), "I will tell you my secret...", false));
        messages.add(new Message(new Patient("Wilson", 65, "Male", 152, 5, 3), "Hello, I have a question about...", true));
        messages.add(new Message(new Patient("Trent", 72, "Male", 160, 6, 2),  "Just for testing", true));
        messages.add(new Message(new Patient("Yuzhong", 61, "Male", 148, 5, 2), "...", true));
