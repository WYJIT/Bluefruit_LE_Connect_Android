...
public class MessageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        messages.add(new Message(new Patient("Jordan", 62, "Female", 158, 7),  "Hello, just wanna double check...", false));
        messages.add(new Message(new Patient("Issac", 55, "Male", 136, 6), "I will tell you my secret...", false));
        messages.add(new Message(new Patient("Wilson", 65, "Male", 152, 5), "Hello, I have a question about...", true));
